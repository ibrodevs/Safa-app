...
class ClientRegisterStep1Screen extends StatefulWidget {
  const ClientRegisterStep1Screen({super.key});

  @override
  State<ClientRegisterStep1Screen> createState() =>
      _ClientRegisterStep1ScreenState();
}

class _ClientRegisterStep1ScreenState extends State<ClientRegisterStep1Screen> {
...
class ClientRegisterStep2Screen extends StatefulWidget {
  ...
  @override
  State<ClientRegisterStep2Screen> createState() =>
      _ClientRegisterStep2ScreenState();
}
