...
class ServiceConfig {
  ...
  static const ServiceConfig amanat = ServiceConfig(
    type: 'amanat',
    title: 'Аманат',
    shortDescription: 'Пожертвование на Медресе',
    orderSubtitle: 'Укажите точку помощи Медресе и опишите пожертвование',
    ...
    allowsIntermediateStops: false,
    destinationLabel: 'Куда',
    destinationHint: 'Куда направить пожертвование',
    primaryActionLabel: 'Оформить пожертвование на Медресе',
